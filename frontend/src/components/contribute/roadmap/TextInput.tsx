...
const TextInput = ({
  ...
  <div className="grid gap-0.5 group relative pt-3 pb-5">
    ...
    <input
      ...
      className="peer focus:placeholder-purple-500/80 placeholder:text-xs rounded-lg bg-home-secondary focus:bg-home-primary text-home-text py-2 px-2 text-sm font-light outline-none drop-shadow-sm transition-all duration-300 ease-in-out focus:ring-2 focus:ring-purple-400/40 focus:shadow-xl focus:shadow-purple-300/20"
    />
    {error ? (
