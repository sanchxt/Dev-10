...
const RecentRoadmaps = () => {
  const { roadmaps } = useSelector((state: RootState) => state.recentlyVisited);

  return (
    <div className="flex items-end">
      <div className="p-1 w-full h-full bg-gradient-to-br from-purple-300 to-purple-500 rounded-lg md:rounded-b-none flex flex-col">
