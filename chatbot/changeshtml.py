...
def main():
    st.markdown('<div class="stHeader"><h1>Developer Resources Chatbot</h1></div>', unsafe_allow_html=True)
    ...
    if st.session_state.embedding_done:
        st.markdown('<div class="stHeader"><h2>Llama3 Powered RAG Q&A</h2></div>', unsafe_allow_html=True)
